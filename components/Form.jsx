  ...
  return (
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      <p className="desc text-left max-w-md">
        {type} and share amazing prompts in the world, and let your imagination run wild with any AI-powered platform.
      </p>
      ...
      >
        ...
        <div className="flex-end mx-3 mb-5 gap-7">
          ...
          <button disabled={submitting} type="submit" className='px-5 py-1.5 text-sm bg-primary-orange rounded-full text-white'>{submitting ? `${type}...` : type}</button>
        </div>
      </form>
    </section>
  )
